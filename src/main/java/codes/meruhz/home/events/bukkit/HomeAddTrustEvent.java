...
import codes.meruhz.home.events.IHomeAddTrustEvent;
...
public class HomeAddTrustEvent extends Event implements IHomeAddTrustEvent {
    ...
    public HomeAddTrustEvent(boolean async, @NotNull Home home, @NotNull UUID trust) {
        super(async);
        this.home = home;
        this.trust = trust;
    }
